...
x = df.iloc[10000:35000, :-1].values
y = df.iloc[10000:35000, -1].values
...
x_train, x_temp, y_train, y_temp = train_test_split(x, y, test_size=.6, random_state=0)
...
#evaluate with test data before training
model.evaluate(x_test, y_test)

#train data - want accuracy to increase, loss to decrease
model.fit(x_train, y_train, batch_size=16, epochs=10)

#evaluate with test data after training 
model.evaluate(x_test, y_test)
